...
const NewFoodCard = ({ recipe }) => {
  const { image, name, description, ingredients, instructions } = recipe;
 

  
  return (
    <li className="relative overflow-hidden hover:z-40  shadow-sm hover:shadow-orange-600 rounded-2xl transform transition-transform duration-200 w-full md:w-[290px] h-[330px] mx-auto delay-75 ">
        ...
        <div className="relative hover:scale-105 transition-all delay-75">
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-black bg-opacity-70 flex flex-col justify-center items-center opacity-0 transition-opacity duration-300 hover:opacity-100">
            ...
            <div className="grid grid-cols-2 justify-center items-center gap-5 ">
              <p className="text-lg font-bold text-amber-600 ">${234}</p>
              <span>
                {" "}
